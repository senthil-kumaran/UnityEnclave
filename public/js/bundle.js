...
var removeAlert = function removeAlert() {
  var child = document.querySelector('.alert');
  if (!child) return;
...
var showAlert = function showAlert(status, message) {
  if (status === 'success') {
    document.querySelector('body').insertAdjacentHTML('afterbegin', "<div class=\"alert alert-success\">".concat(message, "</div>"));
  } else if (status === 'failed') {
    document.querySelector('body').insertAdjacentHTML('afterbegin', "<div class=\"alert alert-failed\">".concat(message, "</div>"));
  }
};
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              window.setTimeout(_alert.removeAlert, 2000);
          ...
          case 7:
            ...
            (0, _alert.showAlert)('failed', _context.t0.response.data.data.message.errorMessage);
            window.setTimeout(_alert.removeAlert, 2000);
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"../../utils/appError.js":[function(require,module,exports) {
...
var AppError = /*#__PURE__*/function (_Error) {
  ...
  function AppError(errorMessage, errorCode) {
    var _this;
    ...
    _this.errorStatus = "".concat(errorCode).startsWith('4') ? 'fail' : 'error';
    _this.errorMessage = errorMessage;
    _this.operational = true;
...
},{"./appError":"../../utils/appError.js"}],"signup.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            res = _context.sent;
            (0, _alert.showAlert)('success', 'Sending welcome mail');

            if (res.data.status === 'success') {
              (0, _alert.removeAlert)();
              (0, _alert.showAlert)('success', 'Logging in!');
              window.setTimeout(_alert.removeAlert, 2000);
              window.setTimeout(function () {
                location.assign('/allHomes');
              }, 1000);
          ...
          case 8:
            ...
            _context.t0 = _context["catch"](0);
            (0, _alert.removeAlert)();
            errMsg = _context.t0.response.data.data.message.errorMessage.split('.');
            (0, _alert.showAlert)('failed', errMsg[0]);
            window.setTimeout(_alert.removeAlert, 2000);
...
},{"axios":"../../node_modules/axios/index.js","../../utils/catchAsync":"../../utils/catchAsync.js","./alert":"alert.js"}],"home.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.uploadHomeImages = exports.deleteHome = exports.updateHome = exports.addHome = void 0;
...
var addHome = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data) {
    var res, homeId, addHomeButton, error;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Home added!');
              window.setTimeout(_alert.removeAlert, 2000);
              localStorage.clear();
              homeId = res.data.data.home._id;
              addHomeButton = document.querySelector('.addHomeBtn');
              addHomeButton.setAttribute('data-id', homeId);
              location.assign("/addHome/page3/".concat(homeId));
            }
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            error = _context.t0.response.data.data.message.errorMessage.split('.')[0];
            (0, _alert.showAlert)('failed', error);
            window.setTimeout(_alert.removeAlert, 3500);
...
var updateHome = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(form, homeId) {
    var res, error;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Home updated!');
              window.setTimeout(_alert.removeAlert, 2000);
              window.setTimeout(function () {
                location.assign('/allHomes');
              }, 1000);
          ...
          case 7:
            _context2.prev = 7;
            _context2.t0 = _context2["catch"](0);
            error = _context2.t0.response.data.data.message.errorMessage.split('.')[0];
            (0, _alert.showAlert)('failed', error);
            window.setTimeout(_alert.removeAlert, 3500);
  ...
  return function updateHome(_x2, _x3) {
    return _ref2.apply(this, arguments);
  };
}();
...
var deleteHome = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(homeId) {
    var res, error;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            res = _context3.sent;
            (0, _alert.showAlert)('success', 'Home deleted!');
            window.setTimeout(_alert.removeAlert, 2000);
            window.setTimeout(function () {
              location.assign('/allHomes');
            }, 1000);
          ...
          case 9:
            ...
            error = _context3.t0.response.data.data.message.errorMessage.split('.')[0];
            (0, _alert.showAlert)('failed', error);
            window.setTimeout(_alert.removeAlert, 3500);
  ...
  return function deleteHome(_x4) {
...
var uploadHomeImages = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(homeId) {
    var res, error;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            res = _context4.sent;
            (0, _alert.showAlert)('success', 'Images added!');
            window.setTimeout(_alert.removeAlert, 2000);
            window.setTimeout(function () {
              location.assign('/allHomes');
            }, 1000);
          ...
          case 9:
            ...
            error = _context4.t0.response.data.data.message.errorMessage.split('.')[0];
            (0, _alert.showAlert)('failed', error);
            window.setTimeout(_alert.removeAlert, 3500);
  ...
  return function uploadHomeImages(_x5) {
    return _ref4.apply(this, arguments);
  };
}();

exports.uploadHomeImages = uploadHomeImages;
...
exports.deleteAccount = exports.passwordChange = exports.account = void 0;
...
var passwordChange = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            errorFromResponse = _context.t0.response.data.data;
            if (!errorFromResponse) (0, _alert.showAlert)('failed', 'Password don\'t match');else (0, _alert.showAlert)('failed', errorFromResponse.message.errorMessage);
            window.setTimeout(_alert.removeAlert, 2000);
  ...
  return function passwordChange(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"newAuthProtocol.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Profile updated');
              window.setTimeout(_alert.removeAlert, 2000);
              window.setTimeout(function () {
                location.assign('/settings');
              }, 1000);
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"gallery.js":[function(require,module,exports) {
"use strict";
...
var _newAuthProtocol = require("./newAuthProtocol");
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return (0, _newAuthProtocol.forgotPassword)({
                email: email
              });
...
if (resetPasswordForm) {
  resetPasswordForm.addEventListener('submit', function (e) {
    ...
    (0, _newAuthProtocol.resetPassword)({
      password: password,
...
var accountIcon = document.querySelector('.account__nav');
...
var addHomeBtn = document.querySelector('.addYourHome');

if (addHomeBtn) {
  addHomeBtn.addEventListener('click', function (e) {
    location.assign('/addHome/page1');
  });
}

var addHomeForm1 = document.querySelector('.addHome__form--page1');

if (addHomeForm1) {
  addHomeForm1.addEventListener('submit', function (e) {
    e.preventDefault();
...
var addHomeForm2 = document.querySelector('.addHome__form--page2');

if (addHomeForm2) {
  addHomeForm2.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
      var block, flatNumber, floor, rent, advance, bedRoom, bathRoom, family, food, negotiable, data, addHomeButton, homeId;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              flatNumber = localStorage.getItem('flat');
              ...
              food = document.getElementById('veg').checked;
              ...
              _context2.next = 14;
              return (0, _home.addHome)(data);

            case 14:
              addHomeButton = document.querySelector('.addHomeBtn');
              homeId = addHomeButton.getAttribute('data-id');
...
var accountPasswordForm = document.querySelector('.account__password--form');

if (accountPasswordForm) {
  accountPasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var currentPassword = document.getElementById('current__password').value;
    var newPassword = document.getElementById('new__password').value;
    var confirmPassword = document.getElementById('confirm__password').value;
    (0, _account.passwordChange)({
...
var profileEditForm = document.querySelector('.form--profileEdit');
...
var editHomeForm1 = document.querySelector('.editHome__form--page1');

if (editHomeForm1) {
  editHomeForm1.addEventListener('submit', function (e) {
    e.preventDefault();
    localStorage.setItem('block', document.querySelector('.block').value);
    localStorage.setItem('flat', document.querySelector('.flat').value);
    localStorage.setItem('floor', document.querySelector('.floor').value);
    ...
    var resourceUrl = btn.getAttribute('data-id');
    location.assign(resourceUrl);
  });
} // Edit home page-2


var editHomeForm2 = document.querySelector('.editHome__form--page2');

if (editHomeForm2) {
  editHomeForm2.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
      var block, flatNumber, floor, rent, advance, bedRoom, bathRoom, family, food, negotiable, btn, homeId, data;
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              homeId = btn.getAttribute('data-id');
              data = {
                block: block,
                flatNumber: flatNumber,
                floor: floor,
              ...
              _context3.next = 16;
              return (0, _home.updateHome)(data, homeId);
...
var deletePage = document.querySelector('.deletePage');

if (deletePage) {
  var homeDeleteButton = document.querySelector('.home__option--delete');

  if (homeDeleteButton) {
    homeDeleteButton.addEventListener('click', function (e) {
      var homeId = homeDeleteButton.getAttribute('data-id');
      (0, _home.deleteHome)(homeId);
    });
  }

  var userDeleteButton = document.querySelector('.user__option--delete');

  if (userDeleteButton) {
    userDeleteButton.addEventListener('click', function (e) {
      (0, _account.deleteAccount)();
    });
  }
} // GALLERY
...
var modalContentImage = document.getElementById('modal--image');
var homeImages = document.querySelectorAll('.home__image'); //Click events for home images 

if (homeImages) {
  homeImages.forEach(function (homeImage) {
...
var editGalleryContainer = document.querySelector('.home__images--container');

if (editGalleryContainer) {
  var deleteHomeImageButtons = document.querySelectorAll('.btn--delete');
  deleteHomeImageButtons.forEach(function (button) {
    button.addEventListener('click', /*#__PURE__*/function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(e) {
        var imageFileName, homeId;
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                imageFileName = e.target.attributes.getNamedItem('data-id').nodeValue;
                homeId = editGalleryContainer.getAttribute('data-id');
                _context4.next = 4;
                return (0, _gallery.deleteImage)({
